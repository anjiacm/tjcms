...
class TjnewpayuseroneiosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function newpayuserone(){
        ...
        $paynewsql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,dem_num,newpayuser) 
                        select 
                        ...
                        y_vip_log p
                            ...
                            p.device_id in 
                            (select 
                                y_wu_tjuserallios.device_id 
                                from  y_wu_tjuserallios 
                                where 
                        ...
                        p.add_time 
                         BETWEEN '.$this->_statdate.'  and '.$this->_enddate.' 
                        and p.status =1
                         and p.dem_num =2 and p.recharge_type =1
                        and p.chanel_bid!=\'\' and p.chanel_web!=\'\' and p.chanel_sid!=\'\' and p.versionid!=\'\'
                        GROUP BY time,chanel,chanel_s,versionid,dem_num 
