...
class TjpaymoneytwodayiosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function paymoneytwo(){
        ...
        $paymoneysql='INSERT INTO y_wu_tjselectday(dodate,channel,channel_t,channel_s,app_version,dem_num,pay_type,paymoney) 
                     select 
                    ...
                    GROUP BY time,chanel,chanel_t,versionid,dem_num,pay_channel
