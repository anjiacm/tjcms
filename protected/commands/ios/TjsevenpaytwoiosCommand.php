...
class TjsevenpaytwoiosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function sevenpaytwo(){
        ...
        $sevsql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,dem_num,pay_type,sevenday) 
                    SELECT 
