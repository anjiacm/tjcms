...
class TjupuseriosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function upuser(){
        ...
        $upsql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,dem_num,openuser) 
                select 
                ...
                BETWEEN '.$this->_statdate.'  and '.$this->_enddate.' 
                 and y_wu_tjuseruphour.chanel_bid!=\'\' and y_wu_tjuseruphour.chanel_web!=\'\' and y_wu_tjuseruphour.chanel_sid!=\'\' and y_wu_tjuseruphour.versionid!=\'\'
