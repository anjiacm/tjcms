...
class TjpaymoneytwoiosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function paymoneytwo(){
        ...
        $paymoneysql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,dem_num,pay_type,paymoney) 
                     select 
                    ...
                    GROUP BY time,chanel,chanel_t,chanel_s,versionid,pay_channel,dem_num
