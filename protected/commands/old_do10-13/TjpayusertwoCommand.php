...
class TjpayusertwoCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function payusertwo(){
        ...
        $payusersql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,pay_type,payuser) 
