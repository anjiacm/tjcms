...
class TjpayusertwodayCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function payusertwo(){
        ...
        $payusersql='INSERT INTO y_wu_tjselectday(dodate,channel,channel_t,channel_s,app_version,pay_type,payuser) 
                        SELECT t.time,t.chanel,t.chanel_t,t.chanel_s,t.versionid,t.pay_channel,count(*) as daysums  from (select  
