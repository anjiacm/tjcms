...
class TjpayuseroneCommand  extends CConsoleCommand
{
    ...
    private function payuserone(){
        ...
        $payusersql='INSERT INTO y_wu_tjselectall(dodate,channel,channel_t,channel_s,app_version,payuser) 
                     SELECT t.time,t.chanel,t.chanel_t,t.chanel_s,t.versionid,count(*) as daysums  from (select  
