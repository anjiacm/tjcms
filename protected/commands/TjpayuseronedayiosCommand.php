...
class TjpayuseronedayiosCommand  extends CConsoleCommand
{
    public $_statdate ;
    public $_enddate ;
    public $_date ;
    ...
    private function payuserone(){
        ...
        $payusersql='INSERT INTO y_wu_tjselectday(dodate,channel,channel_t,channel_s,app_version,dem_num,payuser) 
                     SELECT t.time,t.chanel,t.chanel_t,t.chanel_s,t.versionid,t.dem_num,count(*) as daysums  from (select  
