...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('groupid, logins,lmid', 'length', 'max'=>10),
			...
			array('uid,lmid, username, password, email, groupid, status, addtime, avatar, nickname, sign, web, mobile, qq, register_ip, last_login_ip, logins, username_editable', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            ...
            'lmlist' => array(self::BELONGS_TO, 'WuLmlist', 'lmid')
		);
	}
