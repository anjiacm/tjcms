...
/**
 * This is the model class for table "{{wu_tjuserallios}}".
 *
 * The followings are the available columns in table '{{wu_tjuserallios}}':
 * @property integer $id
 ...
 */
class WuTjuserallios extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('update, usersum, chanel_bid, chanel_sid, versionid, chanel_web, dem_num, phoneid', 'numerical', 'integerOnly'=>true),
			array('quedao, version_name, device_id', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, quedao, update, version_name, device_id, usersum, chanel_bid, chanel_sid, versionid, chanel_web, dem_num, phoneid', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return WuTjuserallios the static model class
	 */
