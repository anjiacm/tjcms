...
/**
 * This is the model class for table "{{wu_tjdayuserios}}".
 *
 * The followings are the available columns in table '{{wu_tjdayuserios}}':
 * @property integer $id
 ...
 */
class WuTjdayuserios extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('userid, dayupdate, upsum, chanel_bid, chanel_sid, versionid, chanel_web, dem_num', 'numerical', 'integerOnly'=>true),
			array('device_id, quedao, version_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userid, device_id, dayupdate, quedao, version_name, upsum, chanel_bid, chanel_sid, versionid, chanel_web, dem_num', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return WuTjdayuserios the static model class
	 */
