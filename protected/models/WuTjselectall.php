...
/**
 * This is the model class for table "{{wu_tjselectall}}".
 *
 * The followings are the available columns in table '{{wu_tjselectall}}':
 * @property integer $id
 ...
 */
class WuTjselectall extends CActiveRecord
{
	/**
	 ...
	 * @return WuTjselectall the static model class
	 */
