...
<head>
    ...
    <script type="text/javascript" src="<?php echo $this->_static_public;?>/js/jquery/2.1.3/jquery.min.js"></script>
...
<div class="header">
  ...
  <div class="logininfo">
	  ...
	  <a href="<?php echo $this->createUrl('user/update', array('id'=>Yii::app()->user->id,'user'=>md5($_SESSION['admingroupid'].'admin')));?>" target="win"><?php echo Yii::t('admin','Update Password');?></a>
...
<script>
    if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {  //判断iPhone|iPad|iPod|iOS
        ...
        window.location.href ="http://local.mantj.com/?r=tjall/mtj/mtj  ";
