...
<?php $form = $this->beginWidget('CActiveForm');?>
    <table class="content_list">
        ...
        <tr>
            <td class="tb_title">推广页域名：</td>
        </tr>
        <tr>
            <td><input type="text" class="txt validate[required]" name="Setting[create_domain]" value="<?php echo $setting['create_domain'] ?>" />
                <span info="Setting[create_domain]"></span></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <select name="Setting[site_status]">
