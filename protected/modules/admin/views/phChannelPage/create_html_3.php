...
<div class="ph_layout p_add">
    ...
    <section class="picIntro clearfix">
        <div class="pic">
            <a id="detail_play_pic" href="javascript:void(0);"  >
                <img src="<?php echo $data[0]['h_img_url'] ?>">
            </a>
        </div>
        <div class="intro" id="detailIntro">
            <span class="sTit">
                <h1><?php echo $data[0]['title'] ?></h1>
            </span>
            <span class="sDes">
                <em class="yellow"><?php echo $data[0]['score'] ?></em>
            </span>
            <span class="sDes">
                   <a href="javascript:;" class="sDes_name"><?php echo $data[0]['actor'] ?></a>
             </span>
            <span class="sDes">
            <em><?php echo $data[0]['year'] ?></em>
                 <i class="iLine">/</i>
                 <a href=""><?php echo $data[0]['area'] ?></a>
                 <i class="iLine">/</i>
                 <a><?php echo $data[0]['type'] ?></a>

             </span>

            <p class="pTxt g_more_arrow_all">
                <?php echo $data[0]['content'] ?>
                <i class="g_more_arrow"></i>
            </p>
    ...
    <p class="pBtn">
            <span>
                <a id="detail_play_button" href="javascript:void(0);">
                    立即播放
                </a>
            </span>
        <span class="">
                <a class="g_btn g_btn_yellow runApp" id="playDownLoadBtn">下载观看</a>
            </span>
    </p>
        ...
        <div class="play_video top_video">
            ...
            <div class="play_info clearfix">
                <div class="info_left">
                    ...
                    <p class="v_info">
                        <!--<span class="v_l">全<label>12</label>集&nbsp;&nbsp;</span>-->
    ...
    <div class="ph_footer">
        ...
        <div class="fo_right"><a href="#" id="js_an" class="IOS"> <span class="icon_down_foot"></span>免费下载</a></div>
    </div>
