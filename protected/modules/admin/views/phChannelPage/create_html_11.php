                            ...
                            if(!empty($playactors)){
                                foreach($playactors as $key=> $item){
                                    ...
                                    <li>
                                        <a href="javascript:;">
                                        <span class="v_pic">
                                                <img src="<?php  echo Helper::getFullUrl($item['title']) ?>">
                                           </span>
                                            <span class="v_in"><?php  echo Helper::getFullUrl($item['avater']) ?></span>
                        ...
                        <div class="list_hot">
                            ...
                            <span class="pic">
                                ...
                                <div class="play_vi"></div>
                                            ...
                                            <span class="des1"><?php echo $post['description']; ?></span>
                                        </a>
                                        <?php
                                    }
                                }
