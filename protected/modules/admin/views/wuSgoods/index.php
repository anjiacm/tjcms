    ...
    <table class="content_list">
        <tr class="tb_header">
                            <th width=\"10%\"><?php echo $form->label($model, 'id');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'goodsid');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 's_goodsname');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 's_goodsimg');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 's_gooddate');?></th>
                            <th>操作</th>
        </tr>
        <?php foreach ($datalist as $row): ?>        <tr class="tb_list">
                               ...
                               value="<?php echo $row->id?>"/><?php echo $row->id?>                    </td>
                                    <td><?php echo $this->_goodstypelist[$row->goodsid]?></td>
                                <td><?php echo $row->s_goodsname?></td>
                                <td><img src="<?php echo $row->s_goodsimg?>" style="width:100px;height: 100px;overflow: hidden;"></td>
                                <td><?php echo date('Y-m-d H:i:s',$row->s_gooddate)?></td>
