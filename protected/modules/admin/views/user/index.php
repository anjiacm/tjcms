...
<div id="contentHeader">
    ...
    <div class="searchArea">
        <ul class="action left" >
            <li><a href="<?php echo $this->createUrl('create' ,array('user'=>md5($_SESSION['admingroupid'].'update')))?>" class="actionBtn"><span><?php echo Yii::t('admin','add');?></span></a></li>
        </ul>
...
<form method="post" action="<?php echo $this->createUrl('batch')?>" name="cpform" >
    <table class="content_list">
        ...
        <tr class="tb_list">
            ...
            <td><?php $lmlist = WuLmlist::model()->findByPk($row->lmid); echo ($row->lmid)==0?'全部':$lmlist->lmname;?> </td>
          ...
          <td>
            <a href="<?php echo  $this->createUrl('update',array('id'=>$row->uid,'user'=>md5($_SESSION['admingroupid'].'update')))?>"><img src="<?php echo $this->module->assetsUrl;?>/images/update.png" align="absmiddle" /></a>&nbsp;&nbsp;
