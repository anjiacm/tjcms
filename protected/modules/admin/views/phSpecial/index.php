    ...
    <table class="content_list">
        <tr class="tb_header">
                            <th width=\"10%\"><?php echo $form->label($model, 'id');?></th>
                                ...
                                <th width=\"10%\"><?php echo $form->label($model, 'description');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'showstyle');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'cover_img');?></th>
        ...
        <?php foreach ($datalist as $row): ?>        <tr class="tb_list">
                               ...
                               value="<?php echo $row->id?>"/><?php echo $row->id?>                    </td>
                                ...
                                <td><?php echo $show_style_list[$row->showstyle]?></td>
                                <td><?php echo $row->cover_img?></td>
