    ...
    <table class="content_list">
        <tr class="tb_header">
                            <th width=\"10%\"><?php echo $form->label($model, 'id');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'typename');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'dodate');?></th>
                                <th width=\"10%\"><?php echo $form->label($model, 'power');?></th>
                            <th>操作</th>
        </tr>
        <?php foreach ($datalist as $row): ?>        <tr class="tb_list">
                               ...
                               value="<?php echo $row->id?>"/><?php echo $row->id?>                    </td>
                                ...
                                <td><?php echo  date('Y-m-d H:i', $row->dodate)?></td>
                                <td><?php echo  $t_statsArray[$row->power]?></td>
