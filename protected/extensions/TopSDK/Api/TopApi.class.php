<?php
Yii::import("ext.TopSDK.Api.top.*");
require_once(Yii::getPathOfAlias('ext') . "/TopSDK/Api/TbkItemInfoGetRequest.class.php");
...
class TopApi
{
    ...
    public function getItemInfo($num_iid)
    {
        ...
        $req->setFields("num_iid,title,pict_url,small_images,reserve_price,zk_final_price,user_type,provcity,item_url,nick,volume");
